function [AudioSpectrumFlatness ,lo_edge, hi_edge, XMLFile ] = AudioSpectrumFlatnessType2(audioData, sr,hopSize,loEdge,hiEdge,writeXML,XMLFile)
...
if isempty(loEdge)	% variable defined but no value
  ...
  if (loEdge < 120 ) 
    loEdge = 120;       % No extraction below 250Hz
  end
end 
