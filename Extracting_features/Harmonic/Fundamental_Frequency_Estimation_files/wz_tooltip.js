...
//jos: var ttBgColor     = "#e6ecff";
var ttBgColor     = "#f0f0ff";
var ttBgImg       = "";           // path to background image;
//jos: var ttBorderColor = "#003399";
var ttBorderColor = "#000040";
var ttBorderWidth = 1;
var ttClickClose  = false;
//jos: var ttDelay       = 500;          // time span until tooltip shows up [milliseconds]
...
var ttShadowColor = "";
var ttShadowWidth = 0;
//jos: var ttStatic      = false;        // tooltip NOT move with the mouse? Alternative: true
var ttStatic      = true;        // tooltip NOT move with the mouse? Alternative: true
var ttSticky      = false;        // do NOT hide tooltip on mouseout? Alternative: true
//jos:We could get by by setting sticky true dynamically only when the tooltip contains links.  However, we plan to always have several links in the near future.
//jos:var ttSticky      = true;   // do NOT hide tooltip on mouseout? Alternative: true
var ttTemp        = 5000;         // time span until tooltip disappears; 0 (zero) means "infinite timespan" [was 0 til 11/10]
...
//jos: var tt_tags = new Array("a","area","b","big","caption","center","code","dd","div","dl","dt","em","h1","h2","h3","h4","h5","h6","i","img","input","li","map","ol","p","pre","s", "select", "small","span","strike","strong","sub","sup","table","td","textarea","th","tr","tt","u","var","ul","layer");
