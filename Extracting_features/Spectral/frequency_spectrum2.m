...
function  freqspectrum = frequency_specrtum2(speechSignal,Fs,frameperiod) 

% Default mpeg-7 value for frame period is 0.016

% [speechSignal, Fs] = audioread(filename);
...
sigFramed = buffer(speechSignal(:,1), winLen, winOverlap, 'nodelay');
