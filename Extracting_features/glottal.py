...
# import Extracting_features.kaldi_io as kal_io
from kaldi_io import write_mat, write_vec_flt
# import Extracting_features.GCI as GCI
...
def glottal_features(audio, flag_plots, size_frame=0.2, size_step=0.1):
    ...
    f0=pysptk.sptk.rapt(data_audiof, fs, int(0.01*fs), min=20, max=1000, voice_bias=-0.2, otype='f0')
