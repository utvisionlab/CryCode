...
# import Extracting_features.utils_gci as util_gci
import utils_gci
from utils_gci import create_continuous_smooth_f0, GetLPCresidual,RCVD_reson_GCI,get_MBS,get_MBS_GCI_intervals,search_res_interval_peaks,RESON_dyProg_mat,calc_residual
import pysptk

from scipy.io.wavfile import write
from scipy.integrate import cumtrapz
# import Extracting_features.peakdetect as peakdet
...
def getF0(audio_file, size_step=0.02, minF0=60, maxF0=500):
    ...
    praat_vuv(audio, temp_filename_f0, temp_filename_vuv, time_stepF0=size_step, minf0=minF0, maxf0=maxF0)
