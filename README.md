...
The whole code can be found at: https://codeocean.com/capsule/0113623/tree/v1

When using the code or the data please cite:
Khozaei, A., Moradi, H., Hosseini, R., Pouretemad, H. and Eskandari, B., 2020. Early screening of autism spectrum disorder using cry features. PloS one, 15(12), p.e0241690.
...
To extract features, the two steps below appears (Praat.exe should be copied to Extracting_features folder):
